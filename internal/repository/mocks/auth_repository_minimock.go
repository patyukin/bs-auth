...
//go:generate minimock -i github.com/patyukin/banking-system/auth/internal/repository.AuthRepository -o ./mocks/auth_repository_minimock.go -n AuthRepositoryMock
